...
3. The way I break down large projects right now is by examining all the systems in the game and seeing what needs to be separated + what features each system needs to work. I believe that bubble diagram break-downs are extremely helpful for this, as I 
## Open-source assets
